  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link text-light" href="<?php echo BASE_URL.SP."acceuil"?>">Acceuil</a>
      </li>
      <li class="nav-item">
    ...
    <a class="nav-link text-light border border border-success" href="<?php echo BASE_URL.SP.'panier'?>">Panier</a>
  </div>
</nav>
    <div class="container">
        <?php echo $content ?>
